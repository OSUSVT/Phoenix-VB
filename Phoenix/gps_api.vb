    ...
    Private Function get_data()
        Try
            ...
            If GPSport.IsOpen Then
                ...
                If (data <> "") Then
                    Dim strArr() As String = data.Split("$") 'split all of the data by line(each line of the gps feed starts with $)
                    old_data = data
                    Return strArr
                Else
                    Dim strArr() As String = old_data.Split("$") 'split all of the data by line(each line of the gps feed starts with $)
                    Return strArr
                End If
            Else
                Return False
